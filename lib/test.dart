...
Future<List<Product>> fetchProducts() async {
  final response = await http.get(Uri.https('http://192.168.43.73:8000','product.json'));
...
Stream<QuerySnapshot> fetchProducts() {
  return FirebaseFirestore.instance.collection('product').snapshots(includeMetadataChanges: true); }

class Test extends StatelessWidget {
  //final Stream<QuerySnapshot> products;
  //Test({Key key, this.products}) : super(key: key);
        ...
        body: Center(
          child: StreamBuilder(
            stream: FirebaseFirestore.instance.collection('product').snapshots(),
              ...
              return Text(snapshot.data.docs.toList().toString());
